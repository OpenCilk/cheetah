...
macro(darwin_add_builtin_library name suffix)
  ...
  set_target_properties(${libname} PROPERTIES
      OUTPUT_NAME ${libname}${CHEETAH_OS_SUFFIX})
  set_target_properties(${libname} PROPERTIES
...
function(darwin_lipo_libs name)
  ...
  if(LIB_DEPENDS AND LIB_LIPO_FLAGS)
    ...
    add_cheetah_install_targets(${name} PARENT_TARGET ${LIB_PARENT_TARGET})
  else()
...
macro(darwin_add_embedded_builtin_libraries)
  ...
  if(CHEETAH_SUPPORTED_ARCH MATCHES ".*armv.*")
    list(FIND CHEETAH_SUPPORTED_ARCH i386 i386_idx)
    if(i386_idx GREATER -1)
      list(APPEND DARWIN_HARD_FLOAT_ARCHS i386)
    endif()

    list(FIND CHEETAH_SUPPORTED_ARCH x86_64 x86_64_idx)
    ...
    set(DARWIN_macho_embedded_LIBRARY_OUTPUT_DIR
      ${CHEETAH_OUTPUT_DIR}/lib/macho_embedded)
    set(DARWIN_macho_embedded_LIBRARY_INSTALL_DIR
      ${CHEETAH_INSTALL_PATH}/lib/macho_embedded)
