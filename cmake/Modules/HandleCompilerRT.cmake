function(find_compiler_rt_library name dest)
  if (NOT DEFINED CHEETAH_COMPILE_FLAGS)
    message(FATAL_ERROR "CHEETAH_COMPILE_FLAGS must be defined when using this function")
  endif()
  set(dest "" PARENT_SCOPE)
  set(CLANG_COMMAND ${CMAKE_CXX_COMPILER} ${CHEETAH_COMPILE_FLAGS}
      "--rtlib=compiler-rt" "--print-libgcc-file-name")
  if (CMAKE_CXX_COMPILER_ID MATCHES Clang AND CMAKE_CXX_COMPILER_TARGET)
    list(APPEND CLANG_COMMAND "--target=${CMAKE_CXX_COMPILER_TARGET}")
  endif()
  get_property(CHEETAH_CXX_FLAGS CACHE CMAKE_CXX_FLAGS PROPERTY VALUE)
  string(REPLACE " " ";" CHEETAH_CXX_FLAGS "${CHEETAH_CXX_FLAGS}")
  list(APPEND CLANG_COMMAND ${CHEETAH_CXX_FLAGS})
  execute_process(
