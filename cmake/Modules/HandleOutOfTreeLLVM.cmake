...
# Rely on llvm-config.
  ...
  elseif(LLVM_CONFIG_PATH)
    ...
    set(CHEETAH_USING_INSTALLED_LLVM 1)
...
macro(configure_out_of_tree_llvm)
  ...
  set(CHEETAH_STANDALONE_BUILD 1)

  find_llvm_parts()

  # Add LLVM Functions --------------------------------------------------------
  if (LLVM_FOUND AND CHEETAH_USING_INSTALLED_LLVM)
  ...
  set(LLVM_LIT_OUTPUT_DIR "${cheetah_BINARY_DIR}/bin")
