...
struct closure_exception final : public reducer_base {
    ...
    virtual reducer_base *identity(void *) noexcept override;
    virtual void reduce(reducer_base *, reducer_base *) noexcept override;
    virtual std::size_t view_size() const noexcept override;
};
